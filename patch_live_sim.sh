...
/const getLiveStockStatus = () => {/ {
    ...
    print "    }";
    print "";
    print "    let globalStock = null;";
    print "    let simulatedGlobalAfter = null;";
...
{ if (!skip) print; }
' > src/pages/Transactions.tsx.new2
mv src/pages/Transactions.tsx.new2 src/pages/Transactions.tsx
